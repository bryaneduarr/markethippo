...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            <p className="mt-2 text-4xl font-bold trackoing-tight text-gray-900 sm:text-5xl">
              Thanks for ordering
            </p>
            ...
            <div className="mt-16 text-sm font-medium">
                      ...
                      <div className="flex-auto flex flex-col justify-between">
                        ...
                        {order._isPaid ? (
                          <a
                            ...
                            className="text-blue-600 hover:underliine underline-offset-2"
                          >
                            Download asset
                          </a>
                        ) : null}
              ...
              <div className="space-y-6 border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
